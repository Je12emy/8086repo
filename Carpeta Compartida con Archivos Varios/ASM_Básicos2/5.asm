;**************************************************************
; Programa "5" Despliegue pantalla e ingresa datos a variables
; declaradas para luego mostrarlas en pantalla con un calculo
;**************************************************************
...
.CODE
        ...
        LEA     DX,MEN1   ; alternativo de mov dx,offset men1
        MOV	    AH,9
        INT     21H 
    ...
    ;add va,vb ;No se puede hacer direccionamiento memoria-memoria
    ...
    MOV 	DL,VA			; se coloca en DL porque así lo requiere 
